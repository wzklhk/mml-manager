...
<template>
  <header class="global-header">
    ...
    <div class="global-header-end">
      ...
      <!-- GitHub -->
      <a href="https://github.com/wzklhk/mml-manager" target="_blank" rel="noopener noreferrer" class="header-icon-btn github-link" title="GitHub">
...
.theme-icon-enter-from { opacity: 0; transform: rotate(-45deg) scale(0.75); }
.theme-icon-leave-to { opacity: 0; transform: rotate(45deg) scale(0.75); }
.lang-btn {
  width: auto;
  padding: 0 8px;
  font-size: 13px;
