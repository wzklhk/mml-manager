...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--type', choices=['auto', 'sql', 'json', 'csv', 'xls', 'tabular'],
...
def main():
    ...
    if input_type == 'auto':
        type_map = {'.sql': 'sql', '.json': 'json', '.csv': 'csv',
                    '.xlsx': 'tabular', '.xls': 'xls'}
    ...
    if input_type == 'tabular':
        output_dir = args.output or os.path.join(
            os.path.dirname(args.input_file), 'mml_output')
